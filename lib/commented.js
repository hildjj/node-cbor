...
/**
  ...
  *
  * @param {StaticCommentOptions|commentCallback|string|number} opts encoding,
  *   max_depth, or callback
  * @param {commentCallback} [cb] - called on completion
  * @returns {{options: StaticCommentOptions, cb: commentCallback}}
  * @private
  */
