(function() {
  ...
  module.exports = Commented = (function(superClass) {
    ...
    function Commented(options) {
      this._pump = bind(this._pump, this);
      var buf, encoding, input, ref;
      ...
      ref = utils.extend({
        ...
        max_depth: 10,
        encoding: 'hex'
      }, options), input = ref.input, this.output = ref.output, this.max_depth = ref.max_depth, encoding = ref.encoding;
    ...
    Commented.comment = function(input, max_depth, cb) {
      ...
      if (typeof max_depth === 'function') {
        ref = [max_depth, 10], cb = ref[0], max_depth = ref[1];
      }
      c = output = null;
      if (cb != null) {
