(function() {
  var BufferStream, DOUBLE, Encoder, FALSE, MAXINT_BN, MT, NULL, NUM_BYTES, SHIFT32, SIMPLE, SYMS, Simple, TAG, TRUE, Tagged, UNDEFINED, bignumber, ref, stream, url,
  ...
  ref = require('./constants'), MT = ref.MT, NUM_BYTES = ref.NUM_BYTES, TAG = ref.TAG, SIMPLE = ref.SIMPLE, SYMS = ref.SYMS;
  ...
  module.exports = Encoder = (function(superClass) {
    ...
    function Encoder(options) {
      ...
      this.semanticTypes = [Array, this._pushArray, Date, this._pushDate, Buffer, this._pushBuffer, RegExp, this._pushRegexp, url.Url, this._pushUrl, bignumber, this._pushBigNumber];
    ...
    Encoder.prototype._pushInt = function(obj, mt) {
      var m;
      m = mt << 5;
      switch (false) {
        case !(obj < 24):
    ...
    Encoder.prototype._pushIntNum = function(obj) {
      if (obj < 0) {
        return this._pushInt(-obj - 1, MT.NEG_INT);
      } else {
    ...
    Encoder.prototype._pushMap = function(obj) {
      var j, k, keys, len1, results;
