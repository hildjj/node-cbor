(function() {
  ...
  module.exports = Encoder = (function(superClass) {
    ...
    function Encoder(options) {
      ...
      this.semanticTypes = [Array, this._pushArray, Date, this._pushDate, Buffer, this._pushBuffer, Map, this._pushMap, RegExp, this._pushRegexp, Set, this._pushSet, url.Url, this._pushUrl, bignumber, this._pushBigNumber];
