...
class Encoder extends stream.Transform {
  ...
  constructor(options) {
    ...
    this.semanticTypes = [
      ...
      Uint8ClampedArray, this._pushUint8ClampedArray,
  ...
  _pushArrayBuffer(gen, obj) {
    return gen._pushUint8Array(gen, new Uint8Array(obj))
  }

  _pushUint8ClampedArray(gen, obj) {
    return gen._pushUint8Array(gen, new Uint8Array(obj.buffer))
  }
