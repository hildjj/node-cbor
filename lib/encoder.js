...
class Encoder {
  ...
  _pushString (obj) {
    ...
    return this._pushInt(len, MT.UTF8_STRING) && this.push(new Buffer(obj, 'utf8'))
  }
  ...
  _pushObject (obj) {
    ...
    // const len1 = this.semanticTypes.length
    for (var i = 0; i < this.semanticTypes.length; i ++) {
  ...
  getResult () {
    ...
    return Buffer.concat.call(Buffer, this.result)
  }
