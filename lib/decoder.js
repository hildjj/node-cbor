(function() {
  var BinaryParseStream, BufferStream, COUNT, Decoder, ERROR, MAJOR, MT, NEG_MAX, NEG_ONE, NOT_FOUND, NUMBYTES, PENDING_KEY, SIMPLE, SYMS, Simple, Tagged, bignumber, parentArray, parentBufferStream, ref, utils,
