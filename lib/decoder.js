(function() {
  var BinaryParseStream, BufferStream, COUNT, CborStream, ERROR, MAJOR, MT, NEG_MAX, NEG_ONE, NOT_FOUND, NUMBYTES, PENDING_KEY, SIMPLE, SYMS, Simple, Tagged, bignumber, parentArray, parentBufferStream, ref, utils,
  ...
  module.exports = CborStream = (function(superClass) {
    ...
    CborStream.NOT_FOUND = NOT_FOUND;
    ...
    CborStream.decodeFirst = function(input, encoding, cb) {
      var c, opts, p, ref1, ref2, required, v;
      if (encoding == null) {
        encoding = 'hex';
      }
      opts = {};
    ...
    CborStream.decodeAll = function(input, encoding, cb) {
      var c, opts, p, ref1, vals;
      if (encoding == null) {
        encoding = 'hex';
      }
      opts = {};
