...
// Minimum string length to cache (from http://cbor.schmorp.de/stringref )
exports.minCborLength = function minCborLength( index )  {
  if (index < 256) {
    return (index < 24) ? 3 : 4
  } 
  return (index < 65536) ? 5 : ((index < 4294967296) ? 7 : 11)
}