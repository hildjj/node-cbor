(function() {
  var BREAK, BinaryParseStream, BufferStream, COUNT, CborStream, ERROR, MAJOR, MAX_SAFE_HIGH, MT, NOTHING, NULL, NUM_BYTES, PARENT, PENDING_KEY, SHIFT_32, SIMPLE, Simple, Tagged, long, parentArray, parseCBORfloat, parseCBORint, ref, utils,
  ...
  module.exports = CborStream = (function(superClass) {
    ...
    CborStream.prototype._parse = function*() {
      var a, again, ai, allstrings, b, buf, i, mt, octet, parent, pm, t;
      parent = null;
      while (true) {
        octet = (yield (-1));
        if (!this.running) {
