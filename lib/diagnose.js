...
/**
  ...
  */
/**
  * @param {StaticDiagnoseOptions|diagnoseCallback|string} opts options,
  *   the callback, or input incoding
  * @param {diagnoseCallback} [cb] - called on completion
  * @returns {{options: StaticDiagnoseOptions, cb: diagnoseCallback}}
  * @private
  */
