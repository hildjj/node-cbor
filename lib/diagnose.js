(function() {
  var BufferStream, Decoder, Diagnose, MT, Simple, bignumber, stream, util, utils,
  ...
  module.exports = Diagnose = (function(superClass) {
    ...
    function Diagnose(options) {
      ...
      this.separator = (ref = options != null ? options.separator : void 0) != null ? ref : '\n';
      if (options != null) {
        delete options.separator;
      }
      this.stream_errors = (ref1 = options != null ? options.stream_errors : void 0) != null ? ref1 : false;
      if (options != null) {
