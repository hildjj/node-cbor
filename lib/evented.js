  ...
  module.exports = EventedParser = (function(_super) {
    ...
    function EventedParser(options) {
      ...
      if (this.options.input != null) {
        this._start(this.options.input, this.options.offset, this.options.encoding);
      } else {
    ...
    EventedParser.prototype.start = function() {
      return this._pump();
    };

    EventedParser.prototype._start = function(input, offset, encoding) {
      if (Buffer.isBuffer(input)) {
        if (this.options.offset) {
          input = input.slice(offset);
        }
        return this.bs = new BufferStream({
          bsInit: input
        });
    ...
    EventedParser.prototype._write = function(chunk, enc, next) {
      return this.bs.write(chunk, enc, next);
    };

    EventedParser.prototype._drainState = function() {
      var kind, tags, _ref;
    ...
    EventedParser.prototype._val = function(val, cb) {
      var kind, tags, _ref;
    ...
    EventedParser.prototype._readBuf = function(len, cb) {
    ...
    EventedParser.prototype._readStr = function(len, cb) {
      return this.bs.wait(len, (function(_this) {
        return function(er, buf) {
          if (er) {
            return cb.call(_this, er);
    ...
    EventedParser.prototype._readArray = function(count, cb) {
      var kind, tags, _ref;
      _ref = this._drainState(), tags = _ref[0], kind = _ref[1];
    ...
    EventedParser.prototype._readMap = function(count, cb) {
    ...
    EventedParser.prototype._readTag = function(val, cb) {
      this.tags.push(val);
      return this._unpack(cb);
    };

    EventedParser.prototype._readSimple = function(val, cb) {
      switch (val) {
        case 20:
    ...
    EventedParser.prototype._getVal = function(val, cb) {
      switch (this.mt) {
        case MT.POS_INT:
    ...
    EventedParser.prototype._stream_stringy = function(cb) {
    ...
    EventedParser.prototype._stream_array = function(cb) {
      var count, keep_going, kind, mt, tags, _ref;
      mt = this.mt;
      _ref = this._drainState(), tags = _ref[0], kind = _ref[1];
      count = 0;
    ...
    EventedParser.prototype._stream_map = function(cb) {
      var count, keep_going, kind, mt, tags, _ref;
      mt = this.mt;
      _ref = this._drainState(), tags = _ref[0], kind = _ref[1];
      count = 0;
    ...
    EventedParser.prototype._stream = function(cb) {
      var kind, tags, _ref;
      switch (this.mt) {
        case MT.BYTE_STRING:
        case MT.UTF8_STRING:
    ...
    EventedParser.prototype._unpack = function(cb) {
    ...
    EventedParser.prototype._pump = function(er) {
      if (er) {
