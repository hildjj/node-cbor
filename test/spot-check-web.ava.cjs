...
const cbor = require('../packages/cbor-web/dist/cbor.cjs')
const {addBigDecimal} = require('../packages/cbor-bigdecimal/dist/cbor-bigdecimal.cjs')
...
test('bigdecimal', t => {
  addBigDecimal(cbor)
  const pi3 = new addBigDecimal.BigNumber(Math.PI).pow(3)
