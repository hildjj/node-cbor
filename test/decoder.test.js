...
exports.others = function (test) {
  ...
  async.each([
    ...
    [new BigNum(0.2), '0xc4822002'],
    [new BigNum(273.15), '0xc48221196ab3'],
    [new BigNum(0.25), '0xc5822101'],
    [new BigNum(1.5), '0xc5822003'],
    [new BigNum('-0x20000000000000'), '3b001fffffffffffff']
  ], bt, function (er) {
    test.ifError(er)
    test.done()
  })
...
exports.add_tag = function (test) {
  ...
  test.deepEqual(d.tags[0], replaceTag)
  test.deepEqual(d.tags[127], newTag)
