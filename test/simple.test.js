...
exports.create = function (test) {
  ...
  test.throws(function () {
    new cbor.Simple('0') // eslint-disable-line
  })
  test.throws(function () {
    new cbor.Simple(-1) // eslint-disable-line
  })
  test.throws(function () {
    new cbor.Simple(256) // eslint-disable-line
  })
  test.throws(function () {
    new cbor.Simple(1.1) // eslint-disable-line
  })
