...
const Simple = cbor.Simple
const Tagged = cbor.Tagged
const hex = require('../lib/utils').hex
...
exports.from_spec = function (test) {
  testAll(test, [
    ...
    [new BigNum('18446744073709551616'), '0xc249010000000000000000'],

    // JS rounding: -18446744073709552000
    // ['-18446744073709551616', '0x3bffffffffffffffff'],

    // draft-03 says -18446744073709551617
    [new BigNum('-18446744073709551617'), '0xc349010000000000000000'],
...
exports.decimal = function (test) {
  testAll(test, [
    [new BigNum(10.1), '0xc482201865'],
    [new BigNum(100.1), '0xc482201903e9'],
    [new BigNum(0.1), '0xc4822001'],
    [new BigNum(-0.1), '0xc4822020'],
    [new BigNum(0), '0xc24100'],
    [new BigNum(-0), '0xc340'],
    [new BigNum('18446744073709551615.1'), 'c48220c24909fffffffffffffff7'],
    [new BigNum(NaN), '0xf97e00'],
    [new BigNum(Infinity), '0xf97c00'],
    [new BigNum(-Infinity), '0xf9fc00']
  ])
}
