...
declare class Diagnose extends stream.Transform {
     ...
     * @param {StaticDiagnoseOptions|diagnoseCallback|string} [options={}] -
     *   options, the callback, or the input encoding
     * @param {diagnoseCallback} [cb] - callback
     * @returns {Promise} if callback not specified
     */
    static diagnose(input: string | Buffer | ArrayBuffer | Uint8Array | Uint8ClampedArray | DataView | stream.Readable, options?: StaticDiagnoseOptions | diagnoseCallback | string, cb?: diagnoseCallback): Promise<any>;
    /**
...
declare namespace Diagnose {
    export { DiagnoseOptions, StaticDiagnoseOptions, diagnoseCallback };
}
import stream = require("node/stream");
import Decoder = require("./decoder");
type StaticDiagnoseOptions = {
    /**
